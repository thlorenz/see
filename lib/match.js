      ...
      return es.through(
        ...
        , function end () {
            if (matchingLineInfos.length) {
              ...
              // worried about memory usage here? we are streaming my friend, so don't!
              var result = { file: entry, matches: matchingLineInfos, lines: allLines, content: allLines.join('\n') }; 
